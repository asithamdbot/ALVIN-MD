...
console.log("Connecting THARU-MD BOT 💫...");
...
let up = `🚀 *_THARU-MD Connected Successfully!_* ✅ 

--- *😈🎉 _Welcome to THARU-MD!_* 🎉😈 
...
*👨‍💻ᴛʜᴀʀᴜ-ᴍᴅ ᴍᴀᴅᴇ ʙʏ ᴛʜᴀʀᴜꜱʜᴀ👨‍💻*  `;

conn.sendMessage(ownerNumber + "@s.whatsapp.net", { image: { url: `https://files.catbox.moe/zb4ncl.jpg` }, caption: up })
